...
aws s3 rb s3://rig.${NAME_SUFFIX}.${PROJECT}.${REGION}.foundation
aws s3 rb s3://rig.${NAME_SUFFIX}.${PROJECT}.${REGION}.infradev
aws s3 rb s3://rig.${NAME_SUFFIX}.${PROJECT}.${REGION}.build
